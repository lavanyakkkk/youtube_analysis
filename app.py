...
atlas_username = 'kumaranlavanya3'
atlas_password = 'Lavan2911'
atlas_cluster = 'cluster0'
client = MongoClient(
    f"mongodb+srv://{atlas_username}:{atlas_password}@{atlas_cluster}.q6xll43.mongodb.net/?retryWrites=true&w=majority")
#mongodb+srv://kumaranlavanya3:<password>@cluster0.q6xll43.mongodb.net/?retryWrites=true&w=majority

db = client['youtube_data']
collection = db['channel_data']
Api_key='AIzaSyC7k0IJJ2o5jV82ODNJFvpiabYwhb4hBv8'
